...
* [Chaos Monkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,112 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - A resiliency tool that helps applications tolerate random instance failures.
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,338 | 🐛 105 | 🌐 Go | 📅 2026-09-01 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,896 | 🐛 546 | 🌐 Go | 📅 2026-09-10 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,516 | 🐛 367 | 🌐 Python | 📅 2026-09-10 - An Easy to Use and Powerful Chaos Engineering Toolkit.
* [orchestrator](https://github.com/github/orchestrator) ⚠️ Archived - MySQL replication topology management and HA.
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,611 | 🐛 400 | 🌐 Go | 📅 2026-08-25 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
* [kube-monkey](https://github.com/asobti/kube-monkey) ⭐ 3,078 | 🐛 25 | 🌐 Go | 📅 2026-09-04 - An implementation of Netflix's Chaos Monkey for Kubernetes clusters.
* [kubedoom](https://github.com/storax/kubedoom) ⭐ 2,169 | 🐛 4 | 🌐 C++ | 📅 2024-08-20 - Kill Kubernetes pods by playing Id's DOOM.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 495 | 🐛 138 | 🌐 Python | 📅 2026-09-09 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,150 | 🐛 6 | 🌐 Go | 📅 2026-09-14 - Chaos testing and network emulation for Docker containers (and clusters).
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,500 | 🐛 108 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
