...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,300 | 🐛 104 | 🌐 Go | 📅 2026-09-01 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
...
* [kube-burner](https://github.com/cloud-bulldozer/kube-burner) ⭐ 789 | 🐛 21 | 🌐 Go | 📅 2026-09-02 - A tool aimed at stressing Kubernetes clusters by creating or deleting a high quantity of objects.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 494 | 🐛 138 | 🌐 Python | 📅 2026-09-03 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
