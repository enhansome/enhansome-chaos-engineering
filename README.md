...
* [Chaos Monkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,137 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - A resiliency tool that helps applications tolerate random instance failures.
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,350 | 🐛 106 | 🌐 Go | 📅 2026-09-15 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,903 | 🐛 546 | 🌐 Go | 📅 2026-09-10 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,524 | 🐛 370 | 🌐 Python | 📅 2026-09-15 - An Easy to Use and Powerful Chaos Engineering Toolkit.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 503 | 🐛 138 | 🌐 Python | 📅 2026-09-17 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,153 | 🐛 7 | 🌐 Go | 📅 2026-09-17 - Chaos testing and network emulation for Docker containers (and clusters).
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,522 | 🐛 108 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
