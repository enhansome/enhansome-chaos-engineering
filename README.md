...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,281 | 🐛 105 | 🌐 Go | 📅 2026-08-04 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,855 | 🐛 551 | 🌐 Go | 📅 2026-08-18 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,499 | 🐛 365 | 🌐 Python | 📅 2026-08-17 - An Easy to Use and Powerful Chaos Engineering Toolkit.
* [orchestrator](https://github.com/github/orchestrator) ⚠️ Archived - MySQL replication topology management and HA.
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,601 | 🐛 414 | 🌐 Go | 📅 2026-07-31 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
* [kube-monkey](https://github.com/asobti/kube-monkey) ⭐ 3,068 | 🐛 25 | 🌐 Go | 📅 2026-08-12 - An implementation of Netflix's Chaos Monkey for Kubernetes clusters.
* [kubedoom](https://github.com/storax/kubedoom) ⭐ 2,166 | 🐛 4 | 🌐 C++ | 📅 2024-08-20 - Kill Kubernetes pods by playing Id's DOOM.
* [Chaos Toolkit](https://github.com/chaostoolkit/chaostoolkit) ⭐ 2,019 | 🐛 3 | 🌐 Python | 📅 2026-08-09 - A chaos engineering toolkit to help you build confidence in your software system.
* [PowerfulSeal](https://github.com/bloomberg/powerfulseal) ⭐ 1,980 | 🐛 55 | 🌐 Python | 📅 2023-11-10 - Adds chaos to your Kubernetes clusters, so that you can detect problems in your systems as early as possible. It kills targeted pods and takes VMs up and down.
...
* [kube-burner](https://github.com/cloud-bulldozer/kube-burner) ⭐ 788 | 🐛 26 | 🌐 Go | 📅 2026-08-19 - A tool aimed at stressing Kubernetes clusters by creating or deleting a high quantity of objects.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 490 | 🐛 139 | 🌐 Python | 📅 2026-08-24 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* [failure-lambda](https://github.com/gunnargrosch/failure-lambda) ⭐ 100 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-20 - A small Node module for injecting failure into AWS Lambda using latency, exception, statuscode or diskspace.
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,136 | 🐛 3 | 🌐 Go | 📅 2026-08-24 - Chaos testing and network emulation for Docker containers (and clusters).
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,459 | 🐛 98 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
