...
* [Chaos Monkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,107 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - A resiliency tool that helps applications tolerate random instance failures.
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,323 | 🐛 105 | 🌐 Go | 📅 2026-09-01 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,885 | 🐛 544 | 🌐 Go | 📅 2026-09-10 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,512 | 🐛 367 | 🌐 Python | 📅 2026-09-10 - An Easy to Use and Powerful Chaos Engineering Toolkit.
* [orchestrator](https://github.com/github/orchestrator) ⚠️ Archived - MySQL replication topology management and HA.
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,610 | 🐛 398 | 🌐 Go | 📅 2026-08-25 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
...
* [Chaos Toolkit](https://github.com/chaostoolkit/chaostoolkit) ⭐ 2,024 | 🐛 3 | 🌐 Python | 📅 2026-08-09 - A chaos engineering toolkit to help you build confidence in your software system.
* [PowerfulSeal](https://github.com/bloomberg/powerfulseal) ⭐ 1,982 | 🐛 55 | 🌐 Python | 📅 2023-11-10 - Adds chaos to your Kubernetes clusters, so that you can detect problems in your systems as early as possible. It kills targeted pods and takes VMs up and down.
...
* [kube-burner](https://github.com/cloud-bulldozer/kube-burner) ⭐ 789 | 🐛 17 | 🌐 Go | 📅 2026-09-03 - A tool aimed at stressing Kubernetes clusters by creating or deleting a high quantity of objects.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 494 | 🐛 138 | 🌐 Python | 📅 2026-09-09 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* [failure-lambda](https://github.com/gunnargrosch/failure-lambda) ⭐ 100 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-09 - A small Node module for injecting failure into AWS Lambda using latency, exception, statuscode or diskspace.
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,146 | 🐛 5 | 🌐 Go | 📅 2026-09-10 - Chaos testing and network emulation for Docker containers (and clusters).
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,490 | 🐛 106 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
