...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,320 | 🐛 105 | 🌐 Go | 📅 2026-09-01 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,883 | 🐛 544 | 🌐 Go | 📅 2026-09-06 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,510 | 🐛 367 | 🌐 Python | 📅 2026-09-09 - An Easy to Use and Powerful Chaos Engineering Toolkit.
* [orchestrator](https://github.com/github/orchestrator) ⚠️ Archived - MySQL replication topology management and HA.
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,608 | 🐛 398 | 🌐 Go | 📅 2026-08-25 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
...
* [kube-burner](https://github.com/cloud-bulldozer/kube-burner) ⭐ 789 | 🐛 18 | 🌐 Go | 📅 2026-09-03 - A tool aimed at stressing Kubernetes clusters by creating or deleting a high quantity of objects.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 495 | 🐛 137 | 🌐 Python | 📅 2026-09-09 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* [failure-lambda](https://github.com/gunnargrosch/failure-lambda) ⭐ 100 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-07 - A small Node module for injecting failure into AWS Lambda using latency, exception, statuscode or diskspace.
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,146 | 🐛 4 | 🌐 Go | 📅 2026-09-02 - Chaos testing and network emulation for Docker containers (and clusters).
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,489 | 🐛 105 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
