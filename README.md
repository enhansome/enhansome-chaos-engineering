...
* [Chaos Monkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,120 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - A resiliency tool that helps applications tolerate random instance failures.
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,341 | 🐛 106 | 🌐 Go | 📅 2026-09-15 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,899 | 🐛 544 | 🌐 Go | 📅 2026-09-10 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,517 | 🐛 367 | 🌐 Python | 📅 2026-09-15 - An Easy to Use and Powerful Chaos Engineering Toolkit.
* [orchestrator](https://github.com/github/orchestrator) ⚠️ Archived - MySQL replication topology management and HA.
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,612 | 🐛 400 | 🌐 Go | 📅 2026-08-25 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
...
* [ChaosKube](https://github.com/linki/chaoskube) ⭐ 1,935 | 🐛 37 | 🌐 Go | 📅 2026-09-01 - chaoskube periodically kills random pods in your Kubernetes cluster.
...
* [kube-burner](https://github.com/cloud-bulldozer/kube-burner) ⭐ 791 | 🐛 19 | 🌐 Go | 📅 2026-09-03 - A tool aimed at stressing Kubernetes clusters by creating or deleting a high quantity of objects.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 495 | 🐛 139 | 🌐 Python | 📅 2026-09-09 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,151 | 🐛 6 | 🌐 Go | 📅 2026-09-14 - Chaos testing and network emulation for Docker containers (and clusters).
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,504 | 🐛 108 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
