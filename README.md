...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,285 | 🐛 103 | 🌐 Go | 📅 2026-08-25 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,858 | 🐛 550 | 🌐 Go | 📅 2026-08-27 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
...
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,603 | 🐛 396 | 🌐 Go | 📅 2026-08-25 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
* [kube-monkey](https://github.com/asobti/kube-monkey) ⭐ 3,071 | 🐛 25 | 🌐 Go | 📅 2026-08-12 - An implementation of Netflix's Chaos Monkey for Kubernetes clusters.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 491 | 🐛 139 | 🌐 Python | 📅 2026-08-25 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,137 | 🐛 3 | 🌐 Go | 📅 2026-08-27 - Chaos testing and network emulation for Docker containers (and clusters).
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,462 | 🐛 99 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
