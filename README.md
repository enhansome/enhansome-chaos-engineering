...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,266 | 🐛 105 | 🌐 Go | 📅 2026-08-04 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,847 | 🐛 550 | 🌐 Go | 📅 2026-08-18 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
...
* [kube-burner](https://github.com/cloud-bulldozer/kube-burner) ⭐ 787 | 🐛 22 | 🌐 Go | 📅 2026-08-19 - A tool aimed at stressing Kubernetes clusters by creating or deleting a high quantity of objects.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 486 | 🐛 141 | 🌐 Python | 📅 2026-08-18 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,116 | 🐛 20 | 🌐 Go | 📅 2026-07-27 - Chaos testing and network emulation for Docker containers (and clusters).
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,445 | 🐛 97 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
