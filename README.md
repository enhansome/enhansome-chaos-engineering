...
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,915 | 🐛 546 | 🌐 Go | 📅 2026-09-10 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
...
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,620 | 🐛 393 | 🌐 Go | 📅 2026-09-22 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 505 | 🐛 143 | 🌐 Python | 📅 2026-09-23 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,534 | 🐛 111 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
