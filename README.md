# Awesome Chaos Engineering with stars
...
* The Road to Chaos - Velocity 2017- [video](https://www.youtube.com/watch?v=FCZVAZaXIjs) & [slides](https://github.com/norajones/Presentations/blob/master/The%20Road%20To%20Chaos%20-%20Velocity%202017.pdf) ⭐ 1 | 🐛 0 | 📅 2019-10-27
...
* A Chaos Engineering Bootcamp for O'Reilly Velocity 2017 - [Slides](https://speakerdeck.com/tammybutow/chaos-engineering-bootcamp) & [Source code](https://github.com/tammybutow/chaos_engineering_bootcamp) ⭐ 171 | 🐛 0 | 🌐 Shell | 📅 2018-06-24
...
* [Chaos Monkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,141 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - A resiliency tool that helps applications tolerate random instance failures.
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,355 | 🐛 105 | 🌐 Go | 📅 2026-09-15 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,909 | 🐛 546 | 🌐 Go | 📅 2026-09-10 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,522 | 🐛 371 | 🌐 Python | 📅 2026-09-21 - An Easy to Use and Powerful Chaos Engineering Toolkit.
* [orchestrator](https://github.com/github/orchestrator) ⚠️ Archived - MySQL replication topology management and HA.
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,618 | 🐛 389 | 🌐 Go | 📅 2026-09-21 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
* [kube-monkey](https://github.com/asobti/kube-monkey) ⭐ 3,080 | 🐛 5 | 🌐 Go | 📅 2026-09-20 - An implementation of Netflix's Chaos Monkey for Kubernetes clusters.
* [kubedoom](https://github.com/storax/kubedoom) ⭐ 2,172 | 🐛 4 | 🌐 C++ | 📅 2024-08-20 - Kill Kubernetes pods by playing Id's DOOM.
* [Chaos Toolkit](https://github.com/chaostoolkit/chaostoolkit) ⭐ 2,027 | 🐛 3 | 🌐 Python | 📅 2026-08-09 - A chaos engineering toolkit to help you build confidence in your software system.
* [PowerfulSeal](https://github.com/bloomberg/powerfulseal) ⭐ 1,983 | 🐛 55 | 🌐 Python | 📅 2023-11-10 - Adds chaos to your Kubernetes clusters, so that you can detect problems in your systems as early as possible. It kills targeted pods and takes VMs up and down.
* [ChaosKube](https://github.com/linki/chaoskube) ⭐ 1,938 | 🐛 37 | 🌐 Go | 📅 2026-09-01 - chaoskube periodically kills random pods in your Kubernetes cluster.
...
* [KubeInvaders](https://github.com/lucky-sideburn/KubeInvaders) ⭐ 1,126 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-23 - Gamfied Chaos engineering tool for Kubernetes Clusters
* [Muxy](https://github.com/mefellows/muxy/) ⭐ 826 | 🐛 8 | 🌐 Go | 📅 2021-01-13 - A chaos testing tool for simulating a real-world distributed system failures.
* [kube-burner](https://github.com/cloud-bulldozer/kube-burner) ⭐ 792 | 🐛 20 | 🌐 Go | 📅 2026-09-03 - A tool aimed at stressing Kubernetes clusters by creating or deleting a high quantity of objects.
* [kubethanos](https://github.com/berkay-dincer/kubethanos) ⭐ 624 | 🐛 0 | 🌐 Go | 📅 2020-06-09 - Kills half of your randomly selected Kubernetes pods.
...
* [go-fault](https://github.com/github/go-fault) ⭐ 556 | 🐛 1 | 🌐 Go | 📅 2026-09-07 - Fault injection middleware in Go
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 503 | 🐛 141 | 🌐 Python | 📅 2026-09-17 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* [Byte-Monkey](https://github.com/mrwilson/byte-monkey) ⭐ 229 | 🐛 3 | 🌐 Java | 📅 2020-10-13 - Bytecode-level fault injection for the JVM. It works by instrumenting application code on the fly to deliberately introduce faults like exceptions and latency.
* [Pod-Reaper](https://github.com/target/pod-reaper) ⚠️ Archived - A rules based pod killing container. Pod-Reaper was designed to kill pods that meet specific conditions that can be used for Chaos testing in Kubernetes.
* [Simoorg](https://github.com/linkedin/simoorg) ⭐ 190 | 🐛 13 | 🌐 Python | 📅 2017-12-27 - Linkedin’s very own failure inducer framework.
...
* [Chaos HTTP Proxy](https://github.com/bouncestorage/chaos-http-proxy) ⭐ 147 | 🐛 6 | 🌐 Java | 📅 2026-09-01 - Introduce failures into HTTP requests via a proxy server
...
* [failure-lambda](https://github.com/gunnargrosch/failure-lambda) ⭐ 100 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-13 - A small Node module for injecting failure into AWS Lambda using latency, exception, statuscode or diskspace.
...
* [GomJabbar](https://github.com/outbrain/GomJabbar) ⭐ 31 | 🐛 8 | 🌐 Java | 📅 2024-09-10 - ChaosMonkey for your private cloud
* [chaos-dingo](https://github.com/jmspring/chaos-dingo) ⭐ 11 | 🐛 5 | 🌐 JavaScript | 📅 2019-09-05 - A tool to mess with Azure services using the Azure NodeJS SDK.
* [gorm-sqlchaos](https://github.com/u2386/gorm-sqlchaos) ⭐ 7 | 🐛 1 | 🌐 Go | 📅 2021-09-17 - A runtime SQL manipulator for your Golang applications based on gorm.
* [vue-chaos](https://github.com/aviadhahami/vue-chaos) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2020-10-11 - A chaos engineering tool for your Vue apps
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,171 | 🐛 7 | 🌐 Go | 📅 2026-09-17 - Chaos testing and network emulation for Docker containers (and clusters).
...
* [The Simian Army](https://github.com/Netflix/SimianArmy) ⚠️ Archived - A suite of tools for keeping your cloud operating in top form.
* [ChaoSlingr](https://github.com/Optum/ChaoSlingr) ⚠️ Archived - Introducing Security Chaos Engineering. ChaoSlingr focuses primarily on the experimentation on AWS Infrastructure to proactively instrument system security failure through experimentation.
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,529 | 🐛 110 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
...
* [CNCF Chaos Engineering Working Group Github](https://github.com/chaoseng/wg-chaoseng) ⭐ 112 | 🐛 3 | 📅 2020-05-15
