...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,357 | 🐛 105 | 🌐 Go | 📅 2026-09-15 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,913 | 🐛 546 | 🌐 Go | 📅 2026-09-10 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
...
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,620 | 🐛 391 | 🌐 Go | 📅 2026-09-22 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 505 | 🐛 141 | 🌐 Python | 📅 2026-09-23 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,173 | 🐛 7 | 🌐 Go | 📅 2026-09-17 - Chaos testing and network emulation for Docker containers (and clusters).
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,533 | 🐛 111 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
