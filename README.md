...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,352 | 🐛 105 | 🌐 Go | 📅 2026-09-15 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,908 | 🐛 546 | 🌐 Go | 📅 2026-09-10 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,520 | 🐛 371 | 🌐 Python | 📅 2026-09-19 - An Easy to Use and Powerful Chaos Engineering Toolkit.
* [orchestrator](https://github.com/github/orchestrator) ⚠️ Archived - MySQL replication topology management and HA.
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,617 | 🐛 392 | 🌐 Go | 📅 2026-09-20 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
* [kube-monkey](https://github.com/asobti/kube-monkey) ⭐ 3,079 | 🐛 25 | 🌐 Go | 📅 2026-09-04 - An implementation of Netflix's Chaos Monkey for Kubernetes clusters.
...
* [PowerfulSeal](https://github.com/bloomberg/powerfulseal) ⭐ 1,984 | 🐛 55 | 🌐 Python | 📅 2023-11-10 - Adds chaos to your Kubernetes clusters, so that you can detect problems in your systems as early as possible. It kills targeted pods and takes VMs up and down.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 503 | 🐛 139 | 🌐 Python | 📅 2026-09-17 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,166 | 🐛 7 | 🌐 Go | 📅 2026-09-17 - Chaos testing and network emulation for Docker containers (and clusters).
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,528 | 🐛 110 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
