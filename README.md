...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,279 | 🐛 105 | 🌐 Go | 📅 2026-08-04 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,854 | 🐛 551 | 🌐 Go | 📅 2026-08-18 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
...
* [kube-monkey](https://github.com/asobti/kube-monkey) ⭐ 3,067 | 🐛 25 | 🌐 Go | 📅 2026-08-12 - An implementation of Netflix's Chaos Monkey for Kubernetes clusters.
...
* [kube-burner](https://github.com/cloud-bulldozer/kube-burner) ⭐ 788 | 🐛 24 | 🌐 Go | 📅 2026-08-19 - A tool aimed at stressing Kubernetes clusters by creating or deleting a high quantity of objects.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 490 | 🐛 138 | 🌐 Python | 📅 2026-08-24 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,134 | 🐛 3 | 🌐 Go | 📅 2026-08-24 - Chaos testing and network emulation for Docker containers (and clusters).
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,458 | 🐛 97 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
