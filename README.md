...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,278 | 🐛 105 | 🌐 Go | 📅 2026-08-04 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,853 | 🐛 551 | 🌐 Go | 📅 2026-08-18 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,498 | 🐛 365 | 🌐 Python | 📅 2026-08-17 - An Easy to Use and Powerful Chaos Engineering Toolkit.
...
* [PowerfulSeal](https://github.com/bloomberg/powerfulseal) ⭐ 1,979 | 🐛 55 | 🌐 Python | 📅 2023-11-10 - Adds chaos to your Kubernetes clusters, so that you can detect problems in your systems as early as possible. It kills targeted pods and takes VMs up and down.
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,133 | 🐛 3 | 🌐 Go | 📅 2026-08-24 - Chaos testing and network emulation for Docker containers (and clusters).
