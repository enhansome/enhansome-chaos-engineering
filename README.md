...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,271 | 🐛 105 | 🌐 Go | 📅 2026-08-04 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,849 | 🐛 550 | 🌐 Go | 📅 2026-08-18 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,493 | 🐛 365 | 🌐 Python | 📅 2026-08-17 - An Easy to Use and Powerful Chaos Engineering Toolkit.
* [orchestrator](https://github.com/github/orchestrator) ⚠️ Archived - MySQL replication topology management and HA.
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,599 | 🐛 415 | 🌐 Go | 📅 2026-07-31 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
...
* [kube-burner](https://github.com/cloud-bulldozer/kube-burner) ⭐ 787 | 🐛 23 | 🌐 Go | 📅 2026-08-19 - A tool aimed at stressing Kubernetes clusters by creating or deleting a high quantity of objects.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 486 | 🐛 141 | 🌐 Python | 📅 2026-08-20 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,450 | 🐛 97 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
