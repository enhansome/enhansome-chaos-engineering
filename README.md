...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,294 | 🐛 104 | 🌐 Go | 📅 2026-09-01 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,863 | 🐛 544 | 🌐 Go | 📅 2026-09-01 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
...
* [kube-monkey](https://github.com/asobti/kube-monkey) ⭐ 3,073 | 🐛 25 | 🌐 Go | 📅 2026-08-12 - An implementation of Netflix's Chaos Monkey for Kubernetes clusters.
...
* [kube-burner](https://github.com/cloud-bulldozer/kube-burner) ⭐ 789 | 🐛 25 | 🌐 Go | 📅 2026-08-30 - A tool aimed at stressing Kubernetes clusters by creating or deleting a high quantity of objects.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 494 | 🐛 139 | 🌐 Python | 📅 2026-08-31 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,475 | 🐛 104 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
