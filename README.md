...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,286 | 🐛 103 | 🌐 Go | 📅 2026-08-25 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
...
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,508 | 🐛 365 | 🌐 Python | 📅 2026-08-25 - An Easy to Use and Powerful Chaos Engineering Toolkit.
* [orchestrator](https://github.com/github/orchestrator) ⚠️ Archived - MySQL replication topology management and HA.
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,603 | 🐛 397 | 🌐 Go | 📅 2026-08-25 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 492 | 🐛 138 | 🌐 Python | 📅 2026-08-25 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,138 | 🐛 3 | 🌐 Go | 📅 2026-08-27 - Chaos testing and network emulation for Docker containers (and clusters).
