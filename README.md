...
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,906 | 🐛 546 | 🌐 Go | 📅 2026-09-10 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,519 | 🐛 371 | 🌐 Python | 📅 2026-09-19 - An Easy to Use and Powerful Chaos Engineering Toolkit.
* [orchestrator](https://github.com/github/orchestrator) ⚠️ Archived - MySQL replication topology management and HA.
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,616 | 🐛 390 | 🌐 Go | 📅 2026-09-17 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
...
* [KubeInvaders](https://github.com/lucky-sideburn/KubeInvaders) ⭐ 1,125 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-23 - Gamfied Chaos engineering tool for Kubernetes Clusters
...
* Chaos engineering for Docker:
  * [Pumba](https://github.com/gaia-adm/pumba) ⭐ 3,157 | 🐛 7 | 🌐 Go | 📅 2026-09-17 - Chaos testing and network emulation for Docker containers (and clusters).
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,526 | 🐛 109 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
