...
* [Chaos Monkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,145 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - A resiliency tool that helps applications tolerate random instance failures.
...
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,910 | 🐛 546 | 🌐 Go | 📅 2026-09-10 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,521 | 🐛 371 | 🌐 Python | 📅 2026-09-21 - An Easy to Use and Powerful Chaos Engineering Toolkit.
* [orchestrator](https://github.com/github/orchestrator) ⚠️ Archived - MySQL replication topology management and HA.
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,618 | 🐛 389 | 🌐 Go | 📅 2026-09-22 - Framework for Kubernetes environments that enables users to run test suites, capture logs, generate reports and perform chaos tests.
...
* [Chaos Toolkit](https://github.com/chaostoolkit/chaostoolkit) ⭐ 2,028 | 🐛 3 | 🌐 Python | 📅 2026-08-09 - A chaos engineering toolkit to help you build confidence in your software system.
...
* [KubeInvaders](https://github.com/lucky-sideburn/KubeInvaders) ⭐ 1,127 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-23 - Gamfied Chaos engineering tool for Kubernetes Clusters
...
* [kube-burner](https://github.com/cloud-bulldozer/kube-burner) ⭐ 793 | 🐛 20 | 🌐 Go | 📅 2026-09-22 - A tool aimed at stressing Kubernetes clusters by creating or deleting a high quantity of objects.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 503 | 🐛 142 | 🌐 Python | 📅 2026-09-22 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
...
* [Site Reliability Engineering resources](https://github.com/dastergon/awesome-sre) ⭐ 13,530 | 🐛 111 | 📅 2025-08-28 - A curated list of awesome Site Reliability and Production Engineering resources.
