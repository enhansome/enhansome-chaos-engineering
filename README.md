...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,297 | 🐛 104 | 🌐 Go | 📅 2026-09-01 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,865 | 🐛 542 | 🌐 Go | 📅 2026-09-02 - Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments.
...
* [kube-monkey](https://github.com/asobti/kube-monkey) ⭐ 3,075 | 🐛 25 | 🌐 Go | 📅 2026-08-12 - An implementation of Netflix's Chaos Monkey for Kubernetes clusters.
...
* [kube-burner](https://github.com/cloud-bulldozer/kube-burner) ⭐ 789 | 🐛 24 | 🌐 Go | 📅 2026-09-01 - A tool aimed at stressing Kubernetes clusters by creating or deleting a high quantity of objects.
...
* [Kraken](https://github.com/cloud-bulldozer/kraken) ⭐ 494 | 🐛 138 | 🌐 Python | 📅 2026-08-31 - Chaos and resiliency testing tool for Kubernetes and OpenShift.
